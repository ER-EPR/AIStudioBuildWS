 ...
 * @example null
 */
export const JWT_TOKEN: string | null = "your-token-here"; // Real token lives only in the AI Studio app copy — never commit it (this repo is public).
 ...
 */
export const WEBSOCKET_PROXY_URL: string = "wss://cliproxy.savorcare.com/v1/ws";